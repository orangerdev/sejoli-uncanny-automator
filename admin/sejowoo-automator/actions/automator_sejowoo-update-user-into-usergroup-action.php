...
/**
 * Class Automator_Sejowoo_Update_User_Into_Usergroup_Action
 */
class Automator_Sejowoo_Update_User_Into_Usergroup_Action {
	...
	/**
	 * Automator_Sejowoo_Update_User_Into_Usergroup_Action constructor.
	 */
	...
	protected function setup_action() {
		...
		$this->set_action_code( 'SEJOWOO_USER_GROUP' );
		
		$this->set_action_meta( 'SEJOWOO_SET_USER_GROUP' );
		...
		$options_group = array(
			...
			$this->get_action_meta() => array(
				...
				Automator()->helpers->recipe->field->select_field_args(
					array(
						'option_code' => 'SEJOWOO_SET_USER_GROUP',
