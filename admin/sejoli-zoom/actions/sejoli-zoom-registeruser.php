...
/**
 * Class SEJOLI_ZOOM_REGISTERUSER
...
class SEJOLI_ZOOM_REGISTERUSER {
	...
	public function __construct() {
		...
		$this->action_code = 'SEJOLIZOOMREGISTERUSER';
	...
	public function define_action() {
		...
		$action = array(
			...
			'sentence'           => sprintf( __( 'Add the user to {{a meeting:%1$s}}', 'sejoli-uncanny-automator' ), $this->action_meta ),
			'select_option_name' => __( 'Add the user to {{a meeting}}', 'sejoli-uncanny-automator' ),
			'priority'           => 10,
			'accepted_args'      => 1,
